...
def build_llauncher_ui(window):
  ...
  # Parameter Sliders Section
    ...
    for param_key, config in window.PARAM_DEFINITIONS.items():
        if config.get("type") == "float_slider":
           ...
           # Debug-Output live aktualisieren wenn Text geändert wird
            ...
            path_edit.setStyleSheet("margin-top: -4px;")
            ...
            browse_btn.setStyleSheet("QPushButton { background-color: #0078d7; color: white; padding: 6px; border-radius: 3px; } QPushButton:hover { background-color: #006cc1; }")
            ...
            file_edit.setStyleSheet("margin-top: -4px;")
            
            select_btn = QPushButton(gettext("btn_select_file"))
            select_btn.setFixedWidth(80)
            select_btn.setStyleSheet("QPushButton { background-color: #0078d7; color: white; padding: 6px; border-radius: 3px; } QPushButton:hover { background-color: #006cc1; }")
            ...
            clear_btn.setStyleSheet("QPushButton { background-color: #0078d7; color: white; padding: 6px; border-radius: 3px; } QPushButton:hover { background-color: #006cc1; }")
   ...
   # ========== RECHTE SPALTE: Debug Output ==========
    ...
    export_btn.setStyleSheet("QPushButton { background-color: #0078d7; color: white; padding: 6px; border-radius: 3px; } QPushButton:hover { background-color: #006cc1; }")
